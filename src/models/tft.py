...
from pytorch_forecasting.metrics import (MAE, MAPE, RMSE, SMAPE,
                                         MultiHorizonMetric, QuantileLoss)
from pytorch_forecasting.models.base_model import BaseModelWithCovariates
from pytorch_forecasting.models.nn import LSTM, MultiEmbedding
from pytorch_forecasting.utils import (create_mask, detach, integer_histogram,
                                       masked_op, padded_stack, to_list)
from torch import nn
from torchmetrics import Metric as LightningMetric

from .attention import InterpretableMultiHeadAttention
from .utils import AddNorm, GateAddNorm, GatedLinearUnit
from .vsn import GatedResidualNetwork, VariableSelectionNetwork
...
class TemporalFusionTransformer(BaseModelWithCovariates):
    def __init__(
        ...
        **kwargs,
        ...
        """
        Temporal Fusion Transformer for multihorizon time-series forecasting.
